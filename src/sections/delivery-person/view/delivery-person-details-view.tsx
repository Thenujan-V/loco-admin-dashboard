...
import { STATUS, DeliveryPersonRow } from './delivery-person-list-view';
...
const MOCK_PERSON: DeliveryPersonDocuments = {
  id: 1,
  firstname: 'Alex',
  lastname: 'Rider',
...
export default function DeliveryPersonDetailsView({ id }: Props) {
  ...
  const [data, setData] = useState<DeliveryPersonDocuments>(MOCK_PERSON);
